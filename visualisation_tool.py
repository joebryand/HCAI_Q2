...
start_color = (200,0,0) #Rood
end_color = (0,200,0)   #Groen
colors = []
...
def main():
    ...
    FPS = 15    #het maximale aantal frames per seconde dat wordt laten zien.(aantal keer dat de while loop gestart kan worden elke seconde)
